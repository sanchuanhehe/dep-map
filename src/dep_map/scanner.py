...
class AportsScanner:
    ...
    def __init__(self, aports_path: str, repos: Optional[List[str]] = None):
        """
        初始化扫描器
    ...
    def scan_single(self, package_name: str) -> Optional[PackageInfo]:
        """
        扫描单个软件包
    ...
    def _parse_file(self, filepath: str) -> Optional[PackageInfo]:
        """解析单个 APKBUILD 文件"""
    ...
    def resolve_package_name(self, name: str) -> Optional[str]:
        """
